...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
    'name', 'email', 'password', 'role', 'phone', 'barangay_id',
];
...
public function transactions()  { return $this->hasMany(Transaction::class, 'household_user_id'); }
public function pointsLedger()  { return $this->hasMany(PointsLedger::class); }
